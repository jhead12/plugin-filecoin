        ...
        <section className="menu">
            <ul className="main-menu">
                <li
                    className="menu-item"
                    onClick={() =>
                        handleMenuClick("data-transfers", "/src/telemetry.html")
                    }
                >
                    Data Transfers
                </li>
                ...
                <li
                    className="menu-item"
                    onClick={() =>
                        handleMenuClick("database", "http://localhost:8084")
                    }
                >
                    Database
                </li>
                <li
                    className="menu-item"
                    onClick={() =>
                        handleMenuClick("performance", "http://localhost:8085")
                    }
                >
                    Performance
                </li>
