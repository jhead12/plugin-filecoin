...
const ipfs = createHelia({ host: "localhost", port: 5001, protocol: "http" });
...
describe("Storage Tests", () => {
    ...
    beforeEach(async () => {
        ceramicDoc = await TileDocument.createHelia(ceramic, { name: "Test" });
    ...
    it("should createHelia a Ceramic document", async () => {
